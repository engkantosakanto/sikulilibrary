...
class RobotLogger(logging.Logger):
	...
	def screenshot(self, msg="", folder="results/screenshots/", region=(0,0,1920, 1080)):
	...
	def html_logs(self, msg, logfile):
		self.html('<h2><b>%s</b> <a href="../%s" >click here to view the logs: %s</a></h2>' % (msg, logfile, logfile))
